...
class AnaSayfaController extends Controller
{
    public function index(){
        ...
        $urunler_slider = Urun::select('urun.*')
                                ...
                                ->orderBy('guncelleme_tarihi','desc')->take(config('ayar.anasayfa_slider_urun_adet'))->get();
        ...
        $urunler_one_cikan = Urun::select('urun.*')
                                            ...
                                            ->orderBy('guncelleme_tarihi','desc')->take(get_ayar('anasayfa_liste_urun_adet'))->get();
