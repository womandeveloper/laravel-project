...
{
    /*Controller İçerisinde Middleware Kullanımı
    ...
    public function ekle()
    {
        ...
        //Kullanıcı girişi yapanlar için
        if (auth()->check()) {
            //Ver,tabanında bir sepet oluşturma varsa oluşturmayacak
    ...
    public function kaldir($rowid)
    {
        if (auth()->check()) {
            $aktif_sepet_id = session('aktif_sepet_id');
            //Verilen row id değerine göre sepet bilgisi elde etmemizi sağlıyor
