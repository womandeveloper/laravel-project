...
class KategoriController extends Controller
{
    public function index()
    {
        if (request()->filled('aranan') || request()->filled('ust_id')) {
            ...
            //flush: Session içerisinde gelen input değerlerini sıfırlar
            request()->flush();
    ...
    {
        /*
         * Çoka çok yani many to many ilişkili tablolarda silme işlemini Laravel ORM içeriinde Attach,Detach metodları bulunur
         * Attach:many to many ilişkili tabloya kayıt eklemeyi sağlar
         *Detach:many to many tablosundan kayıt silmeyi sağlar
         * */
        ...
        $kategori->delete();    //Kategori::destroy($id); Bunu da kullanabilirsin
