...
@section('content')
    <div class="container">
        ...
        <div class="bg-content">
            <div class="row">
                <div class="col-md-5">
                    <img src="/img/food/400*200-1.jpeg">
                    <hr>
                    <div class="row">
                        <div class="col-xs-3">
                            <a href="#" class="thumbnail"><img src="/img/food/60*60-2.jpeg"></a>
                        </div>
                        <div class="col-xs-3">
                            <a href="#" class="thumbnail"><img src="/img/food/60*60-3.jpeg"></a>
                        </div>
                        <div class="col-xs-3">
                            <a href="#" class="thumbnail"><img src="/img/food/60*60-4.jpeg"></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-7">
